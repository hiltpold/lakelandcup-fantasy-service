...
type Prospect struct {
	...
	LeagueID            *uuid.UUID `json:"leagueID" gorm:"foreignKey:ProspectID;constraint:OnUpdate:CASCADE,OnDelete:SET NULL;"`
	FranchiseID         *uuid.UUID `json:"franchiseID" gorm:"foreignKey:ProspectID;constraint:OnUpdate:CASCADE,OnDelete:SET NULL;"`
